		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<center>Modify Employee</center>
				</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-4"></div>
						<div class="col-lg-4">
							<c:url value="/admin/modifyUser?userid=${userid}"
								var="modifyUser"></c:url>
							<form:form role="form" action="${modifyUser}" method="post"
								modelAttribute="user">
								...
								<div class="input-group ">
									...
									<form:input data-date-format="dd-mm-yyyy" path="dateOfJoining" class="form-control"
										id="hire-date" placeholder="Hire date" />
								...
								<div class="col-lg-12">
								<div class="col-lg-6">
									<button type="submit" class="btn btn-primary col-lg-9">Submit</button>
									</div>
									<div class="col-lg-6">
									<button type="button" class="btn btn-default col-lg-9" onclick="history.go(-1)">Cancel</button>
									</div>
									</div>
									</center>
							</form:form>
